...
namespace ITagency_GL.ASPX.GeneralPayments
{
    public partial class WebForm2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (Session["vwChequeRecieptsReport"] != null)
                {
                    DataTable dt = (DataTable)Session["vwChequeRecieptsReport"];
                    ...
                    string rptFullPath = Server.MapPath("rptChequeReciepts.rpt");
            ...
            {
                Session.Remove("vwChequeRecieptsReport");
            }
        }
    }
}